...
export const DEPARTMENT_SUBJECTS = {
    Preschool:    ["LITERACY", "NUMERACY", "WRITING", "CREATIVE ARTS"],
    LowerPrimary: ["ENGLISH", "MATHS", "SCIENCE", "TWI", "HISTORY", "FRENCH", "CREATIVE ARTS", "RELIGIOUS EDUCATION"],
    UpperPrimary: ["ENGLISH", "MATHS", "SCIENCE", "TWI", "HISTORY", "FRENCH", "CREATIVE ARTS", "RELIGIOUS EDUCATION", "COMPUTING"],
    JuniorHigh:   ["ENGLISH", "MATHS", "SCIENCE", "TWI", "SOCIAL STUDIES", "FRENCH", "CREATIVE ARTS", "RELIGIOUS EDUCATION", "COMPUTING", "CAREER TECHNOLOGY"]
};
